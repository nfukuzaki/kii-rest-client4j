...
public class KiiUserFacebookIntegrationResource extends KiiUserSocialIntegrationResource {
	...
	public KiiUserFacebookIntegrationResource(KiiUserResource parent) {
		super(parent);
	}
	public void link(String accessToken) throws KiiRestException {
		...
		super.link(MediaType.parse(KiiSocialProvider.FACEBOOK.getLinkRequestContentType()), requestBody);
	}
	@Override
